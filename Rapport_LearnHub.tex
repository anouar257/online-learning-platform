...
\begin{titlepage}
    ...
    % Logo LearnHub
    \includegraphics[width=0.3\textwidth]{images/learnhub-logo.svg}
    ...
    \begin{minipage}{0.4\textwidth}
        \begin{flushright}
            \textbf{Encadré par:}\\
            Professeur \_\_\_\_\_\_\_\_\_\_\_\_
        \end{flushright}
    \end{minipage}
...
Mes remerciements s'adressent tout d'abord à mon encadrant, Professeur \_\_\_\_\_\_\_\_\_\_\_\_, pour son soutien, ses conseils avisés et sa disponibilité tout au long de ce travail. Son expertise et ses orientations ont été déterminantes pour mener à bien ce projet.
...
\begin{figure}[h]
    \centering
    \fbox{\parbox{0.8\textwidth}{\centering \vspace{10cm} Insérer le diagramme de classe UML ici}}
...
\vspace{1cm}
\textbf{Note :} Insérez ici votre diagramme d'architecture montrant les interactions entre services

% Placeholder pour le diagramme d'architecture
\begin{figure}[h]
    \centering
    \fbox{\parbox{0.8\textwidth}{\centering \vspace{12cm} Insérer le diagramme d'architecture microservices ici}}
...
\begin{figure}[h]
    \centering
    \fbox{\parbox{0.9\textwidth}{\centering \vspace{10cm} Capture d'écran de la page d'accueil}}
...
\begin{figure}[h]
    \centering
    \fbox{\parbox{0.9\textwidth}{\centering \vspace{10cm} Capture d'écran de la page de connexion}}
...
\begin{figure}[h]
    \centering
    \fbox{\parbox{0.9\textwidth}{\centering \vspace{10cm} Capture d'écran de la page d'inscription}}
...
\begin{figure}[h]
    \centering
    \fbox{\parbox{0.9\textwidth}{\centering \vspace{10cm} Capture d'écran de la liste des cours}}
...
\begin{figure}[h]
    \centering
    \fbox{\parbox{0.9\textwidth}{\centering \vspace{10cm} Capture d'écran des détails du cours}}
...
\begin{figure}[h]
    \centering
    \fbox{\parbox{0.9\textwidth}{\centering \vspace{10cm} Capture d'écran du lecteur de cours}}
...
\begin{figure}[h]
    \centering
    \fbox{\parbox{0.9\textwidth}{\centering \vspace{10cm} Capture d'écran de la liste des professeurs}}
...
\begin{figure}[h]
    \centering
    \fbox{\parbox{0.9\textwidth}{\centering \vspace{10cm} Capture d'écran du dashboard étudiant}}
...
\begin{figure}[h]
    \centering
    \fbox{\parbox{0.9\textwidth}{\centering \vspace{10cm} Capture d'écran du dashboard administrateur}}
...
\begin{figure}[h]
    \centering
    \fbox{\parbox{0.9\textwidth}{\centering \vspace{10cm} Capture d'écran du dashboard admin}}
...
\begin{figure}[h]
    \centering
    \fbox{\parbox{0.9\textwidth}{\centering \vspace{10cm} Capture d'écran du lecteur vidéo}}
